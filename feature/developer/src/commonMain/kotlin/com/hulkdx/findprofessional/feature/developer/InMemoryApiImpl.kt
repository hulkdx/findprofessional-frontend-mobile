...
internal class InMemoryApiImpl : InMemoryApi {
    ...
    private val defaultProfessionals = listOf(
        ...
        Professional(
            ...
            120,
            "EUR",
            "https://i.imgur.com/RKqe779.png",
            "4.0",
            "Supports you with career transitions, interviews, and salary negotiation. Practical, structured guidance with clear next steps.",
            availability = listOf(
                ProfessionalAvailability(
                    id = 7,
        ...
        Professional(
            ...
            60,
            "EUR",
            "https://i.imgur.com/2CDzrw7.png",
            "5.0",
            "Works with founders and professionals to improve strategy, productivity, and decision-making. Ideal for growth plans and overcoming roadblocks.",
            availability = createTodayAvailabilities(),
            reviewSize = "100",
            reviews = listOf(),
        ),
        Professional(
