...
val navigationScreenSerializer: KSerializer<NavigationScreen> =
    object : KSerializer<NavigationScreen> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor("NavigationScreen", PrimitiveKind.STRING)

        override fun serialize(encoder: Encoder, value: NavigationScreen) {
